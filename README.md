...
## Auth + Backend (v1.1.0)
- Firebase Auth anônimo no cliente
- Cloud Functions para login de jogador, acesso admin, acesso desenvolvedor, reset de senha e rotação de senha admin
- Firestore Rules por papel
- migração automática de senhas legadas para hash no backend
